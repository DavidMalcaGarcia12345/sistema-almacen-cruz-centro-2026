...
from .models import Tabla_Cambio_Material_Vehicular , Tabla_Hora_Extra , Tabla_Horario , Tabla_Inventario , Tabla_Recepcion_Material , Tabla_Salida_Material , Tabla_Tecnico_Mecanico
